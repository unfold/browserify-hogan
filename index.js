...
var wrap = function(template) {
    return 'module.exports=(function() {var Template = require(\'hogan.js/lib/template\');var template = new Template(' + template + ');return function(data) {return template.render(data)}}());'
